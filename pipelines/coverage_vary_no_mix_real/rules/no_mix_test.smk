...
rule polish_call:
    ...
    output:
        "test/{iteration}/no_mix/calls_cns/distance_0.01_coverage_{coverage}/round_1_phased.vcf"
    shell:
...
rule call:
    ...
    output:
        "test/{iteration}/no_mix/calls_ref/distance_0.01_coverage_{coverage}/round_1_phased.vcf"
    shell:
